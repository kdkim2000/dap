...
| 7 | `ai-dlc-data-design` | 설계/데이터 | [데이터설계서_DAP_Master_20260603.md](데이터설계서_DAP_Master_20260603.md) + 5·6과목 이론MD 7개 + 문제JSON 7개 + 실기JSON 5개 | ✅ |
| 8 | `ai-dlc-screen-spec` | 설계 | [화면명세서_DAP_Master_20260603.md](화면명세서_DAP_Master_20260603.md) — SCR-012·013 실기 화면 상세 명세 | ✅ |
